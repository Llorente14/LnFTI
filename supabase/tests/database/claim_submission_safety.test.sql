...
insert into auth.users (
  ...
  (
    ...
    'authenticated',
    'authenticated',
    'safetyowner.535240911@stu.untar.ac.id',
    '',
    now(),
    '{}'::jsonb,
    '{"full_name":"Safetyowner User","nim":"535240911"}'::jsonb,
    now(),
    now()
  ),
  (
    ...
    'authenticated',
    'authenticated',
    'safetyclaimant.535240912@stu.untar.ac.id',
    '',
    now(),
    '{}'::jsonb,
    '{"full_name":"Safetyclaimant User","nim":"535240912"}'::jsonb,
    now(),
    now()
  ),
  (
    ...
    'authenticated',
    'authenticated',
    'safetyother.535240913@stu.untar.ac.id',
    '',
    now(),
    '{}'::jsonb,
    '{"full_name":"Safetyother User","nim":"535240913"}'::jsonb,
    now(),
    now()
  ),
  (
    '53519000-0000-4000-8000-000000000014',
    'authenticated',
    'authenticated',
    'safetyverifier.535240914@stu.untar.ac.id',
    '',
    now(),
    '{}'::jsonb,
    '{"full_name":"Safetyverifier User","nim":"535240914"}'::jsonb,
    now(),
    now()
  );
...
insert into public.reports (
  ...
  (
    ...
    'Handed over pouch',
    'Tas',
    'A pouch that has already been handed over.',
    'Private zipper marking.',
    'Gedung R',
    now(),
    'PUBLISHED',
    'HANDED_OVER',
  ...
  (
    ...
    '53519000-0000-4000-8000-000000000011',
    'FOUND',
    'Pending review bottle',
    'Botol & Wadah',
    'A bottle that has not passed verifier review.',
    'Private mark under cap.',
    'Gedung M',
    now(),
    'PENDING_REVIEW',
    'AT_DPM',
  ...
  (
    ...
    '53519000-0000-4000-8000-000000000011',
    'FOUND',
    'Public blue umbrella',
    'Aksesori',
    'A public blue umbrella found near the classroom.',
    'Private sticker under handle.',
    'Gedung L',
    now(),
    'PUBLISHED',
    'AT_DPM',
...
select throws_ok(
  ...
  null,
  'a handed-over report cannot receive a new claim'
);
...
select throws_ok(
  ...
  null,
  'a non-public report cannot receive a claim'
);
...
select throws_ok(
  ...
  null,
  'evidence below the database minimum is rejected'
);
...
select throws_ok(
  ...
  null,
  'evidence above the database maximum is rejected'
);
...
select throws_ok(
  ...
  null,
  'a student cannot forge another claimant ID'
);

select lives_ok(
  $$ insert into public.claims (id, report_id, claimant_id, ownership_evidence_private)
     values ('19000000-0000-4000-8000-000000000111', '19000000-0000-4000-8000-000000000013', '53519000-0000-4000-8000-000000000012', 'The handle has a small hidden white triangle sticker') $$,
  'a verified student can submit a valid claim'
);

select is(
  (select claim_status::text from public.claims where id = '19000000-0000-4000-8000-000000000111'),
  'PENDING',
  'a valid claim defaults to PENDING'
);
...
select throws_ok(
  ...
  null,
  'a verifier cannot submit an ownership claim'
);
