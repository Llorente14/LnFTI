    ...
    <form action={formAction} className="space-y-5">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="space-y-2 sm:col-span-2">
          <label htmlFor="full_name" className="font-heading text-sm font-semibold">
            Nama lengkap
          </label>
          <input
            id="full_name"
            ...
            placeholder="Axel Chrisdy"
          />
        </div>

        <div className="space-y-2">
          <label htmlFor="nim" className="font-heading text-sm font-semibold">
            NIM
          </label>
          <input
            id="nim"
            ...
            className="h-11 w-full rounded-md border bg-surface px-3 text-sm"
            placeholder="535240143"
          />
        </div>

        <div className="space-y-2">
          <label htmlFor="program" className="font-heading text-sm font-semibold">
            Program studi
          </label>
          <input
            id="program"
            type="text"
            value={derived.program}
            readOnly
        ...
        <div className="space-y-2">
          <label htmlFor="cohort" className="font-heading text-sm font-semibold">
            Angkatan
          </label>
          <input
            id="cohort"
            type="text"
            value={derived.cohort}
            readOnly
            className="h-11 w-full rounded-md border bg-muted px-3 text-sm text-muted-foreground"
          />
        </div>
        ...
        <div className="space-y-2">
          <label htmlFor="expected_email" className="font-heading text-sm font-semibold">
            Email seharusnya
          </label>
          <input
            id="expected_email"
            type="text"
            value={derived.expectedEmail}
            readOnly
            className="h-11 w-full rounded-md border bg-muted px-3 text-sm text-muted-foreground"
          />
        </div>
        ...
        <div className="space-y-2 sm:col-span-2">
          ...
          <input
            ...
            className="h-11 w-full rounded-md border bg-surface px-3 text-sm"
            placeholder="axel.535240143@stu.untar.ac.id"
          />
        </div>
